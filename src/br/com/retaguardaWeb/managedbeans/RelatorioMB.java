...
public class RelatorioMB {
	...
	public void relatorioEstoqueAtual() {
		...
		try {
			...
			String titulo = "Relat�rio de Estoque Atual";
	...
	public void relatorioFuncionariosAtivos() {
		...
		String titulo = "Relat�rio de Funcion�rios Ativos";
		HashMap<String, Object> hm = new HashMap<String, Object>();
		try {
	...
	public void relatorioGastosCaixa() {
		...
		String titulo = "Relat�rio de Gasto dos Caixas";
		HashMap<String, Object> hm = new HashMap<String, Object>();
	...
	public void gerarAdv() {
		...
		String titulo = "CARTA DE ADVERT�NCIA DISCIPLINAR";
		HashMap<String, Object> hm = new HashMap<String, Object>();
		hm.put("adv", "");
		try {
	...
	public void relatorioGastosNoMes() {
		...
		HashMap<String, Object> hm = new HashMap<String, Object>();
		 ...
		 String periodo = "De "+ formato.format(getDataInicio()) + " at� " +
